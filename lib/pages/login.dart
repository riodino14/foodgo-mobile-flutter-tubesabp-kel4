        ...
        child: Stack(
          ...
          child: Column(
            ...
            Row(
              ...
              children: [
              Text("Forgot Password?", style: AppWidget.SimpleLineTextFieldStyle(),)
            ],),
            ...
            Center(
              child: Container(
                ...
                child: Center(child: Text("Log In", style: AppWidget.boldWhiteTextFieldStyle(),)),
              ),
            ),
            ...
            Row(
              ...
              children: [
              Text("Don't have an account?", style: AppWidget.SignUpTextFieldStyle(),),
              SizedBox(width: 10.0,),
              GestureDetector(
                onTap: () {
